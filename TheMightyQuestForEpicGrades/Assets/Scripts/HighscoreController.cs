...
public class HighscoreController : MonoBehaviour {
    ...
    public void NextWindowOnClick(int level)
    {
        ...
        neu.name = GameObject.Find("name").GetComponent<Text>();
        neu.zeit = GameObject.Find("zeit").GetComponent<Text>();
        neu.score = GameObject.Find("score").GetComponent<Text>();
